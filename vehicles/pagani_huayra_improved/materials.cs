...
singleton Material(lights_pag_on_intense)
{
   ...
   diffuseMap[1] = "vehicles/pagani_huayra_improved/lights_on_intense.dds";
...
{
    mapTo = "lights_pag_on";
   diffuseMap[1] = "vehicles/pagani_huayra_improved/lights_on.dds";
   diffuseMap[0] = "vehicles/common/null.dds";
   specularMap[0] = "vehicles/common/null.dds";
   specularPower[0] = "128";
   pixelSpecular[0] = "1";
...
singleton Material(PAG_HUAYRA_DISC)
{
    ...
    cubemap = "global_cubemap_metalblurred";
    materialTag0 = "beamng"; materialTag1 = "vehicle";
   colorMap[0] = "/vehicles/pagani_huayra_improved/metalplaceholder.dds";
...
singleton Material(PAG_HUAYRA_PAINT)
{
    ...
    doubleSided = "0";
    translucentZWrite = "1";
    normalMap[0] = "/vehicles/pagani_huayra_improved/Nbody.dds";
    normalMap[1] = "/vehicles/pagani_huayra_improved/Nbody.dds";
   ...
   activeLayers = "2";
   instanceDiffuse[1] = "1";
   baseColorMap[0] = "/vehicles/pagani_huayra_improved/pag_b.dds";
   baseColorMap[2] = "gtr_main_c.dds";
   baseColorFactor[2] = "0.992156923 0.992156923 0.992156923 0.561999977";
   roughnessMap[0] = "/vehicles/pagani_huayra_improved/pag_r.dds";
   clearCoatMap[1] = "/vehicles/pagani_huayra_improved/pag_cc.dds";
   clearCoatFactor[1] = "1";
   opacityMap[1] = "/vehicles/pagani_huayra_improved/pag_cc.dds";
   colorPaletteMap[1] = "/vehicles/pagani_huayra_improved/pag_p.dds";
...
singleton Material(PAG_HUAYRA_MISC)
{
   mapTo = "PAG_HUAYRA_MISC";
    normalMap[0] = "/vehicles/pagani_huayra_improved/misc_nm.dds";
    normalMap[1] = "/vehicles/pagani_huayra_improved/misc_nm.dds";
   doubleSided = "1";
    pixelSpecular[0] = "1";
    pixelSpecular[1] = "1";
    castShadows = "1";
   ...
   baseColorMap[0] = "/vehicles/pagani_huayra_improved/misc.dds";
   baseColorMap[1] = "/vehicles/pagani_huayra_improved/misc.dds";
   metallicFactor[0] = "1";
};
...
{
    mapTo = "PAG_HUAYRA_SW";
    specularMap[0] = "/vehicles/pagani_huayra_improved/cockpit_f_s.dds";
    normalMap[0] = "/vehicles/pagani_huayra_improved/cockpit_f_n.dds";
	diffuseColor[0] = "1 1 1 0.1";
	dynamicCubemap = true;
	doubleSided = "1";
    beamngDiffuseColorSlot = 2; //cubemap = "BNG_Sky_02_cubemap";
    materialTag0 = "beamng"; materialTag1 = "vehicle";
   instanceDiffuse[2] = "1";
   colorMap[0] = "/vehicles/pagani_huayra_improved/cockpit_f.dds";
};
...
singleton Material(PAG_HUAYRA_COCKPIT)
{
   mapTo = "PAG_HUAYRA_COCKPIT";
    specularMap[0] = "/vehicles/pagani_huayra_improved/gauges_s.dds";
    ...
    materialTag0 = "beamng"; materialTag1 = "vehicle";
   instanceDiffuse[2] = "1";
   colorMap[0] = "/vehicles/pagani_huayra_improved/gauges.dds";
   colorMap[1] = "/vehicles/pagani_huayra_improved/gauges.dds";
};
...
singleton Material(PAG_HUAYRA_LEATHER)
{
   mapTo = "PAG_HUAYRA_LEATHER";
    normalMap[0] = "/vehicles/pagani_huayra_improved/leather_b_n.dds";
	dynamicCubemap = false;
	doubleSided = "1";
    beamngDiffuseColorSlot = 2; //cubemap = "BNG_Sky_02_cubemap";
    materialTag0 = "beamng"; materialTag1 = "vehicle";
   version = "1.5";
   instanceDiffuse[2] = "1";
   baseColorMap[0] = "/vehicles/pagani_huayra_improved/leather_b.dds";
...
singleton Material(PAG_HUAYRA_MISC_2)
{
   mapTo = "PAG_HUAYRA_MISC_2";
    normalMap[0] = "/vehicles/pagani_huayra_improved/misc_2_nm.dds";
    normalMap[1] = "/vehicles/pagani_huayra_improved/misc_2_nm.dds";
    doubleSided = "1";
    pixelSpecular[0] = "1";
    pixelSpecular[1] = "1";
    castShadows = "1";
   ...
   roughnessFactor[0] = "0.722649872";
   roughnessFactor[1] = "0.722649872";
   colorMap[0] = "/vehicles/pagani_huayra_improved/misc_2.dds";
   colorMap[1] = "/vehicles/pagani_huayra_improved/misc_2.dds";
   specularMap[0] = "/vehicles/pagani_huayra_improved/misc_2_s.dds";
...
singleton Material(PAG_HUAYRA_PAINT_2)
{
   mapTo = "PAG_HUAYRA_PAINT_2";
    normalMap[0] = "/vehicles/pagani_huayra_improved/body2_n.dds";
    normalMap[1] = "/vehicles/pagani_huayra_improved/body2_n.dds";
    doubleSided = "1";
    pixelSpecular[0] = "1";
    pixelSpecular[1] = "1";
    castShadows = "1";
   ...
   version = "1.5";
   activeLayers = "2";
   baseColorMap[0] = "/vehicles/pagani_huayra_improved/carbon_blackbody2.dds";
   baseColorMap[1] = "/vehicles/pagani_huayra_improved/carbon_blackbody2.dds";
   baseColorFactor[1] = "0.392156988 0.392156988 0.392156988 1";
   roughnessMap[0] = "/vehicles/pagani_huayra_improved/Nbody.dds";
   clearCoatMap[1] = "/vehicles/pagani_huayra_improved/pag_cc.dds";
   clearCoatFactor[1] = "1";
   opacityMap[1] = "/vehicles/pagani_huayra_improved/pag_cc.dds";
   colorPaletteMap[1] = "/vehicles/pagani_huayra_improved/pag_p.dds";
   detailScale[1] = "1 1";
   detailNormalMap[1] = "/vehicles/pagani_huayra_improved/body2_n.dds";
};

singleton Material(COMMON_PAGANI_CARBON)
{
   mapTo = "COMMON_PAGANI_CARBON";
    normalMap[0] = "/vehicles/pagani_huayra_improved/carbon_n.dds";
	diffuseColor[0] = "1 1 1 0.1";
	dynamicCubemap = true;
	doubleSided = "1";
    beamngDiffuseColorSlot = 2; //cubemap = "BNG_Sky_02_cubemap";
    materialTag0 = "beamng"; materialTag1 = "vehicle";
   instanceDiffuse[2] = "1";
   colorMap[0] = "/vehicles/pagani_huayra_improved/carbon_black.dds";
};
...
singleton Material(pag_glass_black)
{
   ...
   detailMapUseUV[0] = "1";
   roughnessFactor[0] = "0";
   baseColorMap[0] = "/vehicles/pagani_huayra_improved/glass_black.dds";
   baseColorMap[1] = "/vehicles/pagani_huayra_improved/glass_black.dds";
   ...
   opacityMap[0] = "/vehicles/pagani_huayra_improved/glass_COLOR.dds";
   reflectivityMap[0] = "vehicles/common/glass_base.dds";
   pixelSpecular[0] = "1";
   detailMapUV[0] = "1";
   translucent = "1";
...
singleton Material(PAG_HUAYRA_BADGES_SKIN)
{
   ...
   version = "1.5";
   normalMap[0] = "/vehicles/pagani_huayra_improved/symbols_nm.dds";
   normalMap[1] = "/vehicles/pagani_huayra_improved/symbols_nm.dds";
   normalMap[2] = "symbols_nm.dds";
   roughnessFactor[0] = "0.234999999";
   baseColorMap[0] = "/vehicles/pagani_huayra_improved/symbols.dds";
   baseColorMap[1] = "/vehicles/pagani_huayra_improved/symbols.dds";
   ...
   opacityMap[0] = "/vehicles/pagani_huayra_improved/symbols_o.dds";
   detailScale[0] = "1 1";
   specular[0] = "Black";
   pixelSpecular[0] = "1";
   castShadows = "0";
   ...
   alphaRef = "0";
   dynamicCubemap = "1";
   persistentId = "e0ce0914-a5ef-4437-a526-ca46c5e7b345";
   materialTag0 = "beamng";
   materialTag1 = "vehicle";
};
...
singleton Material(pag_glass)
{
   ...
   baseColorMap[0] = "/vehicles/pagani_huayra_improved/glass_COLOR.dds";
   baseColorMap[1] = "/vehicles/pagani_huayra_improved/glass_COLOR.dds";
